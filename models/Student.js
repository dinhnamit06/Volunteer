...
class Student extends User {
    ...
    async scanQRCode(qrCode) {
        ...
        const [eventData] = await db.promise().query(
            "SELECT e.EventId, e.Description, r.Role as participant_role FROM event e JOIN registration r ON e.EventId = r.EventId WHERE r.RegistrationId = ?",
            [reg_id]
        );
        ...
        return { points, event_id: eventData[0].EventId };
    }
